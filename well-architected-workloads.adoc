...
| Volume
a| Autosize-mode = grow

| Volume
a| Fractional reserve = 0%

| Volume
a| Snapshot copy reserve = 0%

| Volume
a| Snapshot autodelete (volume/oldest first)

| Volume
a| Space-mgmt-try-first = volume_grow
...
| Volume
a| Tiering-minimum-cooling-days = 7
