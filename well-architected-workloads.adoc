...
---
= Build and operate well-architected workloads with NetApp Workload Factory
:icons: font
:imagesdir: ./media/
...
link:https://docs.netapp.com/us-en/workload-well-architected/learn-custom-rules.html[Learn more about custom rules^].
