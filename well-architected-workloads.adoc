...
* *Operating system*
+
The NFS and iSCSI protocol configurations should be configured as recommended for optimal operating system performance specifically for Oracle databases.
