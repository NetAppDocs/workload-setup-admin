...
Account administrators can turn AI features on or off. If an administrator turns them off, the Ask Me AI assistant will not be available.link:manage-genai-features.html[Learn about managing AI features].
