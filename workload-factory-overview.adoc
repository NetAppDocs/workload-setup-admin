...
Lambda link connectivity::
Use Lambda link connectivity to create a trust relationship and connectivity between a Workload Factory account and one or more FSx for ONTAP file systems. Links let you monitor and manage certain file system features directly from the ONTAP REST API calls that are not available through the Amazon FSx for ONTAP API. 
...
EDA storage operations::
Streamline your Electronic Design Automation (EDA) storage operations in NetApp Workload Factory by optimizing performance, integrating with your IaC to automate storage parameters, and ensuring operational health.
...
NOTE: Account administrators can turn AI features on or off. If an administrator turns them off, the Ask Me AI assistant will not be available. link:manage-genai-features.html[Learn about managing AI features].
...
link:console-experiences.html[Learn more about the different console experiences]
...
link:permissions-reference.html[Learn more about Workload Factory permission policies]
...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/links-overview.html[Learn more about links^]
...
* link:https://docs.netapp.com/us-en/workload-vmware/calculate-evs-savings.html[Learn how to explore savings for your VMware workloads^]
...
link:well-architected-workloads.html[Learn more about well-architected workloads]
