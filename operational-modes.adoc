...
summary: "NetApp Workload Factory provides three operational modes that enable you to carefully control access between Workload Factory and your cloud estate based on your IT policies." 
---
...
Learn more about link:https://docs.netapp.com/us-en/workload-setup-admin/permissions-reference.html[permissions for NetApp Workload Factory].
