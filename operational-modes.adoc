...
Learn more about link:https://review.docs.netapp.com/us-en/workload-setup-admin_simulation-permission-update/permissions-reference.html[permissions for BlueXP workload factory].
