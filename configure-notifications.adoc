...
| FSx for ONTAP file system SSD performance tier reached the warning threshold capacity/percentage total.
| Capacity management
| Warning
| General storage
| FSx for ONTAP file systems
...
| FSx for ONTAP volume inode count reached the warning threshold count/percentage total.
| Capacity management
| Warning
| General storage
| FSx for ONTAP file systems
