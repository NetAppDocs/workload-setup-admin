...
[.lead]
You can configure workload factory to send notifications to an Amazon SNS topic when certain types of events happen. After workload factory publishes a notification to an Amazon SNS topic, subscribers to the topic (such as people or other applications) receive the notifications.
