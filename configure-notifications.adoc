...
For example, the following JSON filter policy filters notifications to reject those that are related to Microsoft SQL Server instances and have a severity of "Recommendation":
[source,json]
----
{
