...
+
For example, the following JSON filter policy accepts notifications that are related to the Storage workloadMicrosoft SQL Server instances and have a severity of "Recommendation":
+
[source,json]
----
{
