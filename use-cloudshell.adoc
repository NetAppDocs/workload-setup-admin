...
When using CloudShell, each time you issue an ONTAP CLI command and an error occurs, you'll get an error response with a description of the failure, the cause of the failure, and a detailed resolution.
