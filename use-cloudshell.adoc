...
image:screenshot-cloudshell-tab-menu-small.png["Screenshot that shows CloudShell tab three-dot menu with options like rename, duplicate, close other tabs, and close all."]
