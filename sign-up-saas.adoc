...
[.lead]
include::https://raw.githubusercontent.com/NetAppDocs/workload-family-internal/tree/first-draft/_include/sign-up-saas.adoc[]

OR

include::https://github.com/NetAppDocs/workload-family-internal/tree/first-draft/_include/sign-up-saas.adoc[]