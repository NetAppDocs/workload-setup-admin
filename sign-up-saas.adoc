...
. On the *Sign up* page, enter the required information to create a NetApp cloud login and click *Sign up*.
+
...
+
An account is the top-level element in NetApp's identity platform. It enables you to add and manage users, roles, and permissions.
+
...
You now have a Workload Factory login and an account. Depending on the operational mode you are planning to use, the next step is to create a connectivity link, which connects Workload Factory's services to your hybrid cloud environment.