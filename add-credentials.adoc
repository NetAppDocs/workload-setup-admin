...
+
NOTE: If you want to use a custom AWS Bedrock model for AI features, you must add extra Bedrock permissions to your IAM policy. link:manage-genai-features.html[Learn about managing AI features and required permissions].
