...
. Replace what is currently in the text box with the JSON document that you copied in step 2.
...
. Back on Add Credentials page in Workload Factory, paste the Role ARN in the *Role ARN* field.
