...
. Select *Continue* to open the AWS Management Console, and then log in to the AWS account for this FSx for ONTAP system.
...
. Select *Associate link* from the Storage page of an FSx for ONTAP system.
