...
----
+
Refer to link:https://docs.netapp.com/us-en/console-automation/platform/grant_types.html#refresh-token[NetApp Console API documentation^] for information on generating a refresh token. Post the output to https://netapp-cloud-account.auth0.com/oauth/token to get the access token.
