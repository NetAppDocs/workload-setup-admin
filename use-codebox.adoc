...
* You'll need a Terraform server to run the commands from. (Add minimum version)
* You'll need to have credentials to log in to your AWS account.

.Steps

. After you have used the UI to define the operation that you want to perform, select image:button-copy-codebox.png[the copy button] to copy the Terraform code in the Codebox.  
