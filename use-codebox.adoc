...
summary: "You can use Codebox to generate the code needed to execute any operation supported by NetApp Workload Factory."
---
...
. After you have used the Workload Factory console to define the operation that you want to perform, copy the code in the Codebox.  
...
. After you have used the Workload Factory console to define the operation that you want to perform, copy the API code in the Codebox.  
...
. After you have used the Workload Factory console to define the operation that you want to perform, copy the AWS CLI in the Codebox.  
...
. After you have used the Workload Factory console to define the operation that you want to perform, download the Terraform code from the Codebox.  
