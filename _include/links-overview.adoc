...
* link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html[Connect a link to an FSx for ONTAP file system]
* link:https://docs.netapp.com/us-en/workload-setup-admin/manage-links.html[Manage links]