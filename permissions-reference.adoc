...
+
NOTE: The following permissions are not required for AWS GovCloud users because AWS Cost Explorer does not support GovCloud regions: `ce:GetCostAndUsage` and `ce:GetTags`.
