...
. Note: "iam:CreateServiceLinkedRole" limited by "iam:AWSServiceName": "ec2.amazonaws.com"*
. Note: "iam:PassRole" limited by "iam:PassedToService": "ec2.amazonaws.com""*
====
