...
| ssm:GetParameter a| Deployment
Management operations
Inventory | Operate
| ssm:PutParameters a| Deployment
Inventory | Operate
| ssm:PutParameter a| Deployment
Management operations | Operate
| ssm:DeleteParameters a| Deployment
Management operations | Operate
