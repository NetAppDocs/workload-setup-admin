...
The following permissions arenow available in _Read/Write_ mode for GenAI:
...
The following permission has been removed from _Read/Write_ mode for GenAI: Bedrock:GetFoundationModel
