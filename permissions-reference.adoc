...
The following permissions are now available in _automate_ mode for VMware workloads:
...
The following permissions are now available in _automate_ mode for GenAI workloads:
