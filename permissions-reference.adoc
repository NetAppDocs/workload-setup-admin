...
[NOTE]
====
To use custom AI settings with your own AWS Bedrock model, add the required Bedrock permissions to your IAM policy. link:manage-genai-features.html[Learn more about managing AI features].
====
...
// START: Gen AI features administration addition (2026-07-17)
.4+| Enable custom configuration for AI features using your own AWS Bedrock instance
| bedrock:ListInferenceProfiles
| Custom AI features configuration
| View, planning, and analysis
| bedrock:GetInferenceProfile
| Custom AI features configuration
| View, planning, and analysis
