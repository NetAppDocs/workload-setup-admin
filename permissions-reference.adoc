...
[role="tabbed-block"]
=====
.View, planning, and analysis permissions
--
[source,json]
----
{
  ...
  "packages": [
    {
      "name": "View, planning, and analysis",
      "description": "Permissions for viewing, planning, and analyzing databases, including resource monitoring and well-architected assessment",
      "immutable": true,
      "isDefault": true,
      "permissions": {
        "Version": "2012-10-17",
        "Statement": [
          ...
          },
          {
            ...
            "Effect": "Allow",
            "Action": ["ssm:GetParameter", "ssm:GetParameters", "ssm:PutParameter", "ssm:DeleteParameters"],
            "Resource": "arn:aws:ssm:*:*:parameter/netapp/wlmdb/*"
          },
          {
            "Sid": "SSMResponseCloudWatch",
            "Effect": "Allow",
            "Action": ["logs:GetLogEvents", "logs:PutRetentionPolicy"],
...
----
--
.Operations and remediation permissions
--
[source,json]
----
{
  ...
  "packages": [
    {
      "name": "Operations and remediation",
      "description": "Additional permissions for operating and remediating databases beyond view, planning, and analyzing capabilities",
      "immutable": false,
      "isDefault": false,
      "permissions": {
        "Version": "2012-10-17",
...
----
{
  ...
  "packages": [
    {
      "name": "Host creation",
      "description": "Additional permissions for creating and managing database host deployments beyond operate and remediate capabilities",
      "immutable": false,
      "isDefault": false,
      "permissions": {
        "Version": "2012-10-17",
    ...
    },
    {
      ...
      "description": "Permissions for FSx operations to support well-architected framework recommendations and optimizations",
      "immutable": false,
      "isDefault": false,
      "permissions": {
        "Version": "2012-10-17",
    ...
    },
    {
      ...
      "description": "Permissions for AWS Compute Optimizer integration to support well-architected framework cost optimization and performance recommendations",
      "immutable": false,
      "isDefault": false,
      "permissions": {
        "Version": "2012-10-17",
    ...
    },
    {
      ...
      "description": "Instance profile permissions for EC2 instances to access AWS services including CloudWatch, SSM, FSx, and logging capabilities",
      "immutable": false,
      "isDefault": false,
      "permissions": {
        "Version": "2012-10-17",
...
.8+| Create CloudWatch logs for validation and provisioning scripts running on EC2 instances
| logs:CreateLogGroup 
| Deployment 
| Read/Write
| logs:CreateLogStream 
