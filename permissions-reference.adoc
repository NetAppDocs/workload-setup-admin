...
=== 30 March 2025
Workload factory provides a permissions check by adding the `iam:SimulatePrincipalPolicy` permission to all workload permission policies. The permission simulates workload operations and checks if you have the required AWS account permissions before deploying resources from workload factory. 
