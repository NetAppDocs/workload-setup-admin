...
| Get specific AWS CloudWatch metrics for compute, storage, and network cost components for FSx for ONTAP, FSx for Windows File Server 
| cloudwatch:GetMetricStatistics | Instance detection in the Inventory and cost components in the savings calculator | Yes | Yes
